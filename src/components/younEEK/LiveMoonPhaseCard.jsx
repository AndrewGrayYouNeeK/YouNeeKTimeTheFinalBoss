...
export default function LiveMoonPhaseCard() {
  ...
  if (loading) {
    return (
      <section className="w-full relative rounded-[1.6rem] overflow-hidden border border-[#7CFF6B]/15 bg-[#101010] p-6 sm:p-8 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.04),0_0_26px_rgba(124,255,107,0.06)]">
  ...
  return (
    <section className="w-full relative rounded-[1.6rem] overflow-hidden border border-[#7CFF6B]/15 bg-[#101010] shadow-[inset_0_0_0_1px_rgba(255,255,255,0.04),0_0_26px_rgba(124,255,107,0.06)]">
      ...
      <div className="relative z-10 px-6 sm:px-8 pt-44 pb-8 flex flex-col items-center text-center">
        <div className="mb-8">
          <p className="font-mono text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.4em] text-[#7CFF6B] drop-shadow-[0_0_8px_rgba(124,255,107,0.4)]">Live moon phase</p>
