    ...
    <div className="flex flex-col items-center justify-center w-full mt-2">
      <Button
        ...
        className={`relative gap-2 rounded-full transition-colors border-2 ${
          enabled
            ? 'bg-[#7CFF6B]/10 text-[#7CFF6B] border-[#7CFF6B]/60 hover:bg-[#7CFF6B]/20 hover:text-[#7CFF6B]'
      ...
      <div className="mt-4 text-center space-y-3 max-w-xs">
        ...
        >
          <SelectTrigger className="w-full bg-black/40 border-[#7CFF6B]/30 text-[#7CFF6B] text-[10px] font-mono uppercase tracking-widest">
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
      ...
      {enabled && (
        <div className="mt-4 text-center space-y-3 max-w-xs">
          <div className="space-y-1">
            <p className="text-[10px] text-[#7CFF6B]/70 font-mono tracking-widest uppercase">
          ...
          <Button
            ...
            className="gap-2 rounded-full border-[#7CFF6B]/30 text-[#7CFF6B]/80 hover:bg-[#7CFF6B]/10 hover:text-[#7CFF6B] text-[10px] font-mono uppercase tracking-widest"
          >
          ...
          <div className="rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-left space-y-1.5">
            ...
            <p className="text-[9px] text-white/35 font-mono leading-relaxed">
              <span className="text-[#7CFF6B]/60">Long buzz</span> = each hour digit of {sourceLabel(clockSource)} (tens, then ones)
            </p>
            <p className="text-[9px] text-white/35 font-mono leading-relaxed">
