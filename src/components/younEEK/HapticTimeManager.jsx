    ...
    <div className="flex flex-col items-center justify-center w-full mt-2">
      <Button
        ...
        className={`relative gap-2 rounded-full transition-colors border-2 ${
          enabled
            ? 'bg-[#ff6a00]/10 text-[#ff6a00] border-[#ff6a00]/60 hover:bg-[#ff6a00]/20 hover:text-[#ff6a00]'
      ...
      <div className="mt-4 text-center space-y-3 max-w-xs">
        ...
        >
          <SelectTrigger className="w-full bg-black/40 border-[#ff6a00]/30 text-[#ff6a00] text-[10px] font-mono uppercase tracking-widest">
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
      ...
      {enabled && (
        <div className="mt-4 text-center space-y-3 max-w-xs">
          <div className="space-y-1">
            <p className="text-[10px] text-[#ff6a00]/70 font-mono tracking-widest uppercase">
          ...
          <Button
            ...
            className="gap-2 rounded-full border-[#ff6a00]/30 text-[#ff6a00]/80 hover:bg-[#ff6a00]/10 hover:text-[#ff6a00] text-[10px] font-mono uppercase tracking-widest"
          >
          ...
          <div className="rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-left space-y-1.5">
            ...
            <p className="text-[9px] text-white/35 font-mono leading-relaxed">
              <span className="text-[#ff6a00]/60">Long buzz</span> = each hour digit of {sourceLabel(clockSource)} (tens, then ones)
            </p>
            <p className="text-[9px] text-white/35 font-mono leading-relaxed">
