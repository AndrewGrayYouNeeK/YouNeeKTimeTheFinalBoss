...
export default function BottomTab() {
  ...
  return (
    <div
      className="fixed bottom-0 left-0 right-0 border-t border-[#7CFF6B]/10 bg-[#050505]/95 backdrop-blur-md flex justify-around z-40"
    ...
    >
      {tabs.map((tab) => {
        ...
        return (
          ...
          >
            <Icon className={`w-6 h-6 ${isActive ? 'drop-shadow-[0_0_8px_rgba(124,255,107,0.8)]' : ''}`} />
