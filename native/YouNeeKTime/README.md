...
The watch app is independent (`WKRunsIndependentlyOfCompanionApp`). Swipe between **Clock Face**, **100.100.100**, and **Settings**. Settings pick Regular / YouNeeK Time / Army YouNeeK / 100.100.100 for the digits, analog hands, and (on the phone) haptic telling.
